...
// CODE HERE
const evenNumbers = mixedNumbers.filter(i => i % 2 === 0)
...
// CODE HERE
const postTaxPrices = prices.map(i => i * 1.07)
console.log(`Total price with tax included`,postTaxPrices)// = prices.map(/* Provide Your Callback Here );
...
// CODE HERE
const myStrongest = monstersInYourPocket.filter(i => i => 200)  // = monstersInYourPocket.filter(/* Provide Your Callback Here */)
console.log(`List by Stregnth`,myStrongest)
...
console.log(`Total Price with Tax`, orderTotals)
...
// CODE HERE
const bobPurchases = purchases.filter(purchases =>purchases.owner === "Bob")
console.log(`Bob's Total Purchases`, bobPurchases)